...
export const NotificationContextProvider = (props) => {
  const [anecdoteNotification, anecdoteNotificationDispatch] = useReducer(notificationReducer, '')

  return (
    <NotificationContext.Provider value={[anecdoteNotification, anecdoteNotificationDispatch] }>
      {props.children}
